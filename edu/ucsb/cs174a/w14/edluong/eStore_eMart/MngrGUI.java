...
public class MngrGUI extends JFrame implements Runnable {
	...
	private void initialize() {
		...
		JButton btnOrderItem = new JButton("Order Shipment");//<--ORDER RESTOCK
		btnOrderItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				System.out.println("Manager GUI - Order Shipment clicked");
			}
		});
		...
		order_table.add(order_controls, BorderLayout.SOUTH);
		...
		JButton btnDeleteAll = new JButton("Delete All Unnecessary");
		...
		JList ordResultsList = new JList();
		ordResults.add(ordResultsList);
		JButton btnOrdNewTerm = new JButton(" Add Term...");
		order_search.add(btnOrdNewTerm, "cell 0 20");
		JButton btnOrdClear = new JButton("Clear Terms");
		order_search.add(btnOrdClear, "cell 0 21,alignx center,aligny center");
